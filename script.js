...
const testimonialBtnContainer = document.querySelector(
...
testimonialBtnContainer.addEventListener("click", function (e) {
  ...
  document
    .querySelector(`.operation-testimonial-content--${clicked.dataset.tab}`)
    .classList.add("operation-testimonial-content--active");
});
...
document.querySelector(".footes-list").addEventListener("click", function (e) {
  e.preventDefault();
...
document.querySelector(".footer-list").addEventListener("click", function (e) {
  e.preventDefault();
